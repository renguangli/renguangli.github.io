...
Docker镜像仓库简单来说就是存储Docker镜像的地方，就像git仓库一样,push、pull镜像。Docker官方提供了Docker Hub来存储我们的镜像文件，用户可以上传或者下载上面的镜像，也可以[搭建私有的Docker registry](https://renguangli.com/docker-registry)。
