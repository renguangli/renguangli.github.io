...
垃圾回收机制(GC)是Java重要特性之一。    
它让开发者无需关注内存的创建和释放，而是通过GC自动回收垃圾(无用对象)。
...
![标记-清除算法](https://renguangli.com/images/gc-mark-scavenging.png)
